...
1. Compile IE, firefox and chrome plugins, which produces next files correspondingly: 
	...
	-$(var.ExtSolutionDir)Release\npesteid-firefox-plugin.dll  "msbuild /t:firefox-token-signing:Rebuild;firefox-token-signing-wix:Rebuild /p:Configuration=Release;Platform=Win32 browser-token-signing.sln"
